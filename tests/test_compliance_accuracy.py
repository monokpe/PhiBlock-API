...
class TestGDPRCompliance:
    ...
    def test_gdpr_pii_detection(self):
        ...
        for prompt, expected_type in test_cases:
            ...
            assert expected_type in entity_types, f"Failed to detect {expected_type} in: {prompt}"
        ...
        for prompt, expected_type in test_cases:
            ...
            type_mapping = {
                ...
                "MEDICAL_RECORD_NUMBER": [
                    "MEDICAL_RECORD_NUMBER",
                    "US_DRIVER_LICENSE",
                ],  # May be detected as similar pattern
                "EMAIL": ["EMAIL"],
    ...
    def test_hipaa_18_identifiers(self):
        ...
        for prompt, expected_type in identifiers:
            ...
            if expected_type in type_variants:
                assert any(
                    t in entity_types for t in type_variants[expected_type]
...
class TestPCIDSSCompliance:
    ...
    def test_pci_credit_card_detection(self):
        ...
        for card_number in test_cases:
            ...
            assert (
                "CREDIT_CARD" in entity_types or "CREDIT_DEBIT_NUMBER" in entity_types
...
class TestCrossFrameworkCompliance:
    ...
    def test_multi_framework_detection(self):
        ...
        result = engine.check_compliance(
            prompt, normalized_entities, frameworks=["GDPR", "HIPAA", "PCI-DSS"]
        )
    ...
    def test_strictest_action_wins(self):
        ...
        result = engine.check_compliance(prompt, normalized_entities, frameworks=["GDPR", "HIPAA"])
